...
def set_variable_value_options(selected_variable):
    try:
        engine.rollback()  # Rollback en caso de error previo
...
@app.callback(
    Output(component_id='output-targeted', component_property='children'),
...
def update_output_div(variable, variable_value):
    try:
        ...
        # Consulta para obtener la productividad objetivo y real promedio
